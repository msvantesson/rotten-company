      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 bg-white border rounded-xl shadow-sm p-8">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-gray-700 mb-4">
            Rotten Company is an evidence‑based accountability platform documenting
            corporate misconduct and systemic harm.
          </p>

          <p className="text-gray-600 text-sm">
            Creating an account allows you to submit evidence, participate in moderation,
            and help keep the platform credible and transparent.
          </p>
        </div>
